...
class WebDeveloperCourseInformationScreen extends StatelessWidget {
  const WebDeveloperCourseInformationScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: AppBar(
        title: Text('Web Developer Information ',style: TextStyle(fontSize: 22,fontWeight: FontWeight.bold,color: Colors.blue),),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const CircleAvatar(
                radius: 70,
                backgroundImage: AssetImage('assets/Image/web.webp'),
              ),
              SizedBox(height: 4,),
              Card(
                child: InkWell(
                  ...
                  child: ListTile(
                    ...
                    leading:  Image.asset('assets/Image/WebDeveloper.jpg'),
